...
public class MyCalculator extends Frame {
	...
	String specialButtonText[] = { "BackSpace", "C", "CE","Back" };
	...
	final int FRAME_WIDTH = 700, FRAME_HEIGHT = 350;
...
///////////////////////////  
	MyCalculator(String frameText)// constructor
	{
		...
		displayLabel.setBackground(new Color(51, 153, 255));
		displayLabel.setForeground(Color.WHITE);
		add(displayLabel);
		memLabel.setBackground(new Color(255, 255, 255));
...
////////////////////////////////////////  
	public static void main(String[] args) {
		new MyCalculator("Calculator Of Travels Management System");
	}
}
